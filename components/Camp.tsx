      ...
      >
        ...
        <div className="flexCenter gap-6">
          <span className="flex -space-x-4  overflow-hidden">
            {PEOPLE_URL.map((url) => (
              <Image
                className="inline-block h-10 w-10 object-contain rounded-full"
                src={url}
                alt="person"
                key={url}
                width={52}
...
const Camp = () => {
  ...
  "
    >
      ...
      items-start justify-start gap-8 overflow-x-auto
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        <div
          className="relative w-full overflow-hidden rounded-3xl bg-green-50 p-8 
